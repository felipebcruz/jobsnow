package br.com.jobsnow.rest_interface.test.client;
...
public class ClientTest {
	...
	public void _setup() {
		...
		this.delete = mock(HttpDelete.class);
	}
	...
	public void _deveMostrarMensagemDeErroQuandoStatusDoGetNaoFor200() throws Exception {
		this.expectedEx.expect(RuntimeException.class);
		this.expectedEx.expectMessage("Falha ao fazer a requisi��o, HTTP error code: " + 400 + ", motivo do erro: ");
	...
	public void _deveExecutarDoPatchERetornarStatusNoContent() throws Exception {
        ...
        new Client(this.client, this.response, this.patch)._doPatch(null,null);
	...
	public void _deveExecutarDoPostERetornarIdGerado() throws Exception {
        ...
        new Client(this.client, this.response, this.post)._doPost(null,null);
