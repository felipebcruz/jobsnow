...
//	@GetMapping("usuarios/{idDoUsuario}/Candidato/processosSeletivos/antigos/total")
	public Map<String, Long> totalDeProcessosSeletivosAntigosDesteCandidato(@PathVariable("idDoUsuario") Long idDoUsuario ) {
...
//		where pc.status = 0 and pc.idCandidato = :idCandidato
		...
		Map<String, Long> totais = tabela._obterTotais(restricoes );
		return totais;
		
//		Map<String, BigDecimal> totais = JobsNowDataBaseClient
...
//		List<Map<String, String>> resultados = this.obterTodosOsIdsMaisNomesDestaTabela(nomeDaTabela);
	...
	List<Map<String, String>> obterTodosOsIdsMaisNomesDestaTabela(String nomeDaTabela) {
