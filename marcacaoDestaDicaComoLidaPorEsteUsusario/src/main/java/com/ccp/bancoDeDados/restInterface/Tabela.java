...
public class Tabela {
	...
	public List<Map<String, String>> _selecioneVariosRegistros(Map<String, String> restricoes, String... quaisCamposTrazer){
		String[] nomes = new String[] {"Tecnologia em Informatica","013 - Recursos Humanos","011 - Engenharia Civil","021 - Engenharia Eletrica","Administracao","Contabilidade"};
	...
	public Long _inserirUmUnicoRegistro(Map<String, String> camposMaisSeusNovosValores){
		...
		System.out.println(new GsonBuilder().setPrettyPrinting().create().toJson(camposMaisSeusNovosValores));
		return null;
	}
